...
/***/ function(module, exports) {
	...
	var _user$project$Bulma$input = function (attrs) {
		return A2(
	...
	var _user$project$Bulma$label = function (name) {
		return A2(
	...
	var _user$project$Bulma$button = F2(
		function (attrs, body) {
			return A2(
				_elm_lang$html$Html$p,
				{
	...
	var _user$project$Bulma$box = function (attrs) {
	...
	var _user$project$Bulma$content = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$cardFooterItem = F2(
		function (attrs, name) {
			return A2(
	...
	var _user$project$Bulma$cardFooter = function (attrs) {
	...
	var _user$project$Bulma$cardContent = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$card = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$column = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$columns = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$tabs = function (attrs) {
		return _elm_lang$html$Html$div(
			{
				ctor: '::',
	...
	var _user$project$Bulma$modal = function (body) {
		return A2(
	...
	var _user$project$Card$authored = F2(
		function (author, card) {
			return A2(
				_elm_lang$core$List$any,
				function (x) {
					return _elm_lang$core$Native_Utils.eq(x.author, author);
				},
				card.contents);
		});
	var _user$project$Card$Card = F4(
		function (a, b, c, d) {
			return {id: a, votes: b, revealed: c, contents: d};
		});
	var _user$project$Card$Content = F3(
		function (a, b, c) {
			return {id: a, text: b, author: c};
		});

	var _user$project$Column$updateCard = F3(
		function (cardId, f, column) {
			return _elm_lang$core$Native_Utils.update(
				column,
				{
					cards: A3(
	...
	var _user$project$Column$removeCard = F2(
		function (cardId, column) {
			return _elm_lang$core$Native_Utils.update(
				column,
				{
					cards: A2(_elm_lang$core$Dict$remove, cardId, column.cards)
				});
		});
	var _user$project$Column$addCard = F2(
		function (card, column) {
			return _elm_lang$core$Native_Utils.update(
				column,
				{
					cards: A3(_elm_lang$core$Dict$insert, card.id, card, column.cards)
				});
		});
	var _user$project$Column$getCard = F2(
		function (cardId, column) {
			return A2(_elm_lang$core$Dict$get, cardId, column.cards);
		});
	var _user$project$Column$Column = F3(
		function (a, b, c) {
			return {id: a, name: b, cards: c};
		});

	var _user$project$DragAndDrop$onDragStart = A2(_elm_lang$html$Html_Attributes$attribute, 'ondragstart', 'event.dataTransfer.setData(\'text/html\', event.target.innerHTML)');
			...
			switch (_p0.ctor) {
				case 'MouseOver':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							dragging: _elm_lang$core$Maybe$Just(_p0._0)
						});
				case 'MouseOut':
					return _elm_lang$core$Native_Utils.update(
						model,
				...
				case 'DragOver':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							over: _elm_lang$core$Maybe$Just(_p0._0)
						});
				case 'DragLeave':
					return _elm_lang$core$Native_Utils.update(
						model,
						{over: _elm_lang$core$Maybe$Nothing});
				default:
					return model;
			}
		});
	var _user$project$DragAndDrop$isDrop = F2(
		function (msg, model) {
			var _p1 = msg;
			if (_p1.ctor === 'Drop') {
				return A3(
	...
	var _user$project$DragAndDrop$empty = {dragging: _elm_lang$core$Maybe$Nothing, over: _elm_lang$core$Maybe$Nothing};
	var _user$project$DragAndDrop$Model = F2(
		function (a, b) {
			return {dragging: a, over: b};
		});
	var _user$project$DragAndDrop$Drop = {ctor: 'Drop'};
	var _user$project$DragAndDrop$onDrop = function (tagger) {
		return A3(
			_elm_lang$html$Html_Events$onWithOptions,
			'drop',
			{preventDefault: true, stopPropagation: false},
			_elm_lang$core$Json_Decode$succeed(
				tagger(_user$project$DragAndDrop$Drop)));
	};
	var _user$project$DragAndDrop$DragLeave = function (a) {
		return {ctor: 'DragLeave', _0: a};
	};
	var _user$project$DragAndDrop$onDragLeave = F2(
		function (tagger, value) {
			return A2(
				...
				_elm_lang$core$Json_Decode$succeed(
					tagger(
						_user$project$DragAndDrop$DragLeave(value))));
		});
	var _user$project$DragAndDrop$DragOver = function (a) {
		return {ctor: 'DragOver', _0: a};
	};
	var _user$project$DragAndDrop$onDragOver = F2(
		function (tagger, value) {
			return A3(
				_elm_lang$html$Html_Events$onWithOptions,
				'dragover',
				...
				_elm_lang$core$Json_Decode$succeed(
					tagger(
						_user$project$DragAndDrop$DragOver(value))));
		});
	var _user$project$DragAndDrop$dropzone = F2(
		function (tagger, value) {
			return {
				ctor: '::',
				_0: A2(_user$project$DragAndDrop$onDragOver, tagger, value),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DragAndDrop$onDragLeave, tagger, value),
					_1: {
						ctor: '::',
						_0: _user$project$DragAndDrop$onDrop(tagger),
						_1: {ctor: '[]'}
					}
				}
			};
		});
	var _user$project$DragAndDrop$DragStart = {ctor: 'DragStart'};
	var _user$project$DragAndDrop$MouseOut = function (a) {
		return {ctor: 'MouseOut', _0: a};
	};
	var _user$project$DragAndDrop$onMouseOut = F2(
		function (tagger, value) {
			return _elm_lang$html$Html_Events$onMouseOut(
				tagger(
					_user$project$DragAndDrop$MouseOut(value)));
		});
	var _user$project$DragAndDrop$MouseOver = function (a) {
		return {ctor: 'MouseOver', _0: a};
	};
	var _user$project$DragAndDrop$onMouseOver = F2(
		function (tagger, value) {
			return _elm_lang$html$Html_Events$onMouseOver(
				tagger(
					_user$project$DragAndDrop$MouseOver(value)));
		});
	var _user$project$DragAndDrop$draggable = F2(
		function (tagger, value) {
			return {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$DragAndDrop$onDragStart,
					_1: {
						ctor: '::',
						_0: A2(_user$project$DragAndDrop$onMouseOver, tagger, value),
						_1: {
							ctor: '::',
							_0: A2(_user$project$DragAndDrop$onMouseOut, tagger, value),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _user$project$Retro$updateColumn = F3(
		function (columnId, f, retro) {
			return _elm_lang$core$Native_Utils.update(
				retro,
				{
					columns: A3(
	...
	var _user$project$Retro$updateCard = F3(
		function (columnId, cardId, f) {
			var updateHelp = function (column) {
				return A3(_user$project$Column$updateCard, cardId, f, column);
			};
			return A2(_user$project$Retro$updateColumn, columnId, updateHelp);
		});
	var _user$project$Retro$revealCard = F2(
		function (columnId, cardId) {
			return A3(
				_user$project$Retro$updateCard,
				columnId,
				cardId,
				function (card) {
					return _elm_lang$core$Native_Utils.update(
	...
	var _user$project$Retro$voteCard = F2(
		function (columnId, cardId) {
			return A3(
				_user$project$Retro$updateCard,
				columnId,
	...
	var _user$project$Retro$addContent = F3(
		function (columnId, cardId, content) {
			return A3(
				_user$project$Retro$updateCard,
				columnId,
				cardId,
	...
	var _user$project$Retro$removeCard = F2(
		function (columnId, cardId) {
			return A2(
				_user$project$Retro$updateColumn,
				columnId,
				_user$project$Column$removeCard(cardId));
		});
	var _user$project$Retro$addCard = F3(
		function (columnId, card, retro) {
			return _elm_lang$core$Native_Utils.update(
				retro,
				{
					columns: A3(
						...
						_elm_lang$core$Maybe$map(
							_user$project$Column$addCard(card)),
						retro.columns)
				});
		});
	var _user$project$Retro$addColumn = F2(
		function (column, retro) {
			return _elm_lang$core$Native_Utils.update(
				retro,
				{
					columns: A3(_elm_lang$core$Dict$insert, column.id, column, retro.columns)
				});
		});
	var _user$project$Retro$getCard = F3(
		function (columnId, cardId, retro) {
			var _p0 = A2(_elm_lang$core$Dict$get, columnId, retro.columns);
			if (_p0.ctor === 'Nothing') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				return A2(_elm_lang$core$Dict$get, cardId, _p0._0.cards);
			}
		});
	var _user$project$Retro$moveCard = F4(
		function (columnFrom, columnTo, cardId, retro) {
			var card = A3(_user$project$Retro$getCard, columnFrom, cardId, retro);
			return _elm_lang$core$Native_Utils.update(
				retro,
				{
					columns: A3(
						_elm_lang$core$Dict$update,
						columnTo,
						A2(_elm_lang$core$Maybe$map2, _user$project$Column$addCard, card),
						A3(
							_elm_lang$core$Dict$update,
							columnFrom,
							_elm_lang$core$Maybe$map(
	...
	var _user$project$Retro$groupCards = F3(
		function (_p2, _p1, retro) {
			var _p3 = _p2;
			var _p8 = _p3._0;
			var _p7 = _p3._1;
			var _p4 = _p1;
			var updateHelp = function (b) {
				var _p5 = A3(_user$project$Retro$getCard, _p8, _p7, retro);
				if (_p5.ctor === 'Just') {
					var _p6 = _p5._0;
					return _elm_lang$core$Native_Utils.update(
						b,
						{
							votes: _p6.votes + b.votes,
							revealed: _p6.revealed || b.revealed,
							contents: _elm_lang$core$List$concat(
								{
									ctor: '::',
									_0: _p6.contents,
									_1: {
			...
			return A4(
				...
				_p4._1,
				updateHelp,
				A3(_user$project$Retro$removeCard, _p8, _p7, retro));
		});
	var _user$project$Retro$empty = {columns: _elm_lang$core$Dict$empty};
	var _user$project$Retro$Retro = function (a) {
		return {columns: a};
	};

	var _user$project$Sock$listen = F2(
		function (url, tagger) {
			return A2(_elm_lang$websocket$WebSocket$listen, url, tagger);
		});
	var _user$project$Sock$socketMsgEncoder = function (value) {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'op',
						_1: _elm_lang$core$Json_Encode$string(value.op)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, value.args))
						},
						_1: {ctor: '[]'}
					}
				}
	...
	var _user$project$Sock$SocketMsg = F3(
		function (a, b, c) {
			return {id: a, op: b, args: c};
		});
	var _user$project$Sock$socketMsgDecoder = A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Sock$SocketMsg))));
	var _user$project$Sock$update = F3(
		function (data, model, f) {
			var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Sock$socketMsgDecoder, data);
			if (_p0.ctor === 'Ok') {
				return A2(f, _p0._0, model);
			} else {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			}
		});
	var _user$project$Sock$send = F3(
		function (id, op, args) {
			return A2(
				...
				A2(
					...
					0,
					_user$project$Sock$socketMsgEncoder(
						A3(_user$project$Sock$SocketMsg, id, op, args))));
		});

	var _user$project$Main$titleCardView = function (title) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('not-card card-content has-text-centered'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
	...
	var _user$project$Main$contentView = function (content) {
		return A2(
			_user$project$Bulma$content,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(content.author),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(content.text),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	var _user$project$Main$contentsView = function (contents) {
		return A2(
			_user$project$Bulma$content,
			{ctor: '[]'},
			A2(
				...
				A2(
					...
					{ctor: '[]'},
					{ctor: '[]'}),
				A2(_elm_lang$core$List$map, _user$project$Main$contentView, contents)));
	};
	...
	var _user$project$Main$storageSet = _elm_lang$core$Native_Platform.outgoingPort(
		'storageSet',
		function (v) {
			return [v._0, v._1];
		});
	var _user$project$Main$storageGet = _elm_lang$core$Native_Platform.outgoingPort(
		'storageGet',
		function (v) {
			return v;
		});
	var _user$project$Main$storageGot = _elm_lang$core$Native_Platform.incomingPort(
		'storageGot',
	...
	var _user$project$Main$Model = F6(
		function (a, b, c, d, e, f) {
			return {user: a, joined: b, stage: c, retro: d, input: e, dnd: f};
		});
	var _user$project$Main$Discussing = {ctor: 'Discussing'};
	var _user$project$Main$Voting = {ctor: 'Voting'};
	var _user$project$Main$Presenting = {ctor: 'Presenting'};
	var _user$project$Main$Thinking = {ctor: 'Thinking'};
	var _user$project$Main$init = A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{user: '', joined: false, stage: _user$project$Main$Thinking, retro: _user$project$Retro$empty, input: '', dnd: _user$project$DragAndDrop$empty},
		{
			ctor: '::',
			_0: _user$project$Main$storageGet('id'),
			_1: {ctor: '[]'}
		});
	var _user$project$Main$socketUpdate = F2(
		function (msg, model) {
			var _p1 = msg.op;
			switch (_p1) {
				case 'stage':
						...
						switch (_p3) {
							case 'Thinking':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{stage: _user$project$Main$Thinking}),
									{ctor: '[]'});
							case 'Presenting':
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{stage: _user$project$Main$Presenting}),
									{ctor: '[]'});
							case 'Voting':
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{stage: _user$project$Main$Voting}),
									{ctor: '[]'});
							case 'Discussing':
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{stage: _user$project$Main$Discussing}),
									{ctor: '[]'});
							default:
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'card':
					...
					if ((((_p4.ctor === '::') && (_p4._1.ctor === '::')) && (_p4._1._1.ctor === '::')) && (_p4._1._1._1.ctor === '[]')) {
						var card = {
							id: _p4._1._0,
							votes: 0,
							revealed: _elm_lang$core$Native_Utils.eq(_p4._1._1._0, 'true'),
							contents: {ctor: '[]'}
						};
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A3(_user$project$Retro$addCard, _p4._0, card, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				case 'content':
					...
					if (((((_p5.ctor === '::') && (_p5._1.ctor === '::')) && (_p5._1._1.ctor === '::')) && (_p5._1._1._1.ctor === '::')) && (_p5._1._1._1._1.ctor === '[]')) {
						var content = {id: '', text: _p5._1._1._1._0, author: msg.id};
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A4(_user$project$Retro$addContent, _p5._0, _p5._1._0, content, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				case 'column':
					...
					if (((_p6.ctor === '::') && (_p6._1.ctor === '::')) && (_p6._1._1.ctor === '[]')) {
						var column = {id: _p6._0, name: _p6._1._0, cards: _elm_lang$core$Dict$empty};
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A2(_user$project$Retro$addColumn, column, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
					...
					if ((((_p7.ctor === '::') && (_p7._1.ctor === '::')) && (_p7._1._1.ctor === '::')) && (_p7._1._1._1.ctor === '[]')) {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A4(_user$project$Retro$moveCard, _p7._0, _p7._1._0, _p7._1._1._0, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
					...
					if (((_p8.ctor === '::') && (_p8._1.ctor === '::')) && (_p8._1._1.ctor === '[]')) {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A3(_user$project$Retro$revealCard, _p8._0, _p8._1._0, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
					...
					if (((((_p9.ctor === '::') && (_p9._1.ctor === '::')) && (_p9._1._1.ctor === '::')) && (_p9._1._1._1.ctor === '::')) && (_p9._1._1._1._1.ctor === '[]')) {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									retro: A3(
										_user$project$Retro$groupCards,
										{ctor: '_Tuple2', _0: _p9._0, _1: _p9._1._0},
										{ctor: '_Tuple2', _0: _p9._1._1._0, _1: _p9._1._1._1._0},
										model.retro)
								}),
							{ctor: '[]'});
					} else {
					...
					if (((_p10.ctor === '::') && (_p10._1.ctor === '::')) && (_p10._1._1.ctor === '[]')) {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									retro: A3(_user$project$Retro$voteCard, _p10._0, _p10._1._0, model.retro)
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				case 'error':
					...
					if ((_p11.ctor === '::') && (_p11._1.ctor === '[]')) {
						return A2(_user$project$Main$handleError, _p11._0, model);
					} else {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
	...
	var _user$project$Main$update = F2(
		function (msg, model) {
			...
			switch (_p12.ctor) {
					...
					return A2(
							...
							{stage: _p15}),
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p15),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						});
				...
				case 'DnD':
					var _p22 = _p12._0;
					var _p16 = A2(_user$project$DragAndDrop$isDrop, _p22, model.dnd);
					if (_p16.ctor === 'Just') {
						var _p21 = _p16._0._1._0;
						var _p20 = _p16._0._0._0;
						var _p19 = _p16._0._0._1;
						...
						switch (_p17.ctor) {
							case 'Thinking':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{dnd: _user$project$DragAndDrop$empty}),
									{
										ctor: '::',
										_0: A3(
											_user$project$Sock$send,
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									dnd: A2(_user$project$DragAndDrop$update, _p22, model.dnd)
								}),
							{ctor: '[]'});
					}
				case 'ChangeInput':
					...
					return A2(_elm_lang$core$String$contains, '\n', _p23) ? A2(
						...
						{ctor: '[]'});
				default:
					return A3(_user$project$Sock$update, _p12._0, model, _user$project$Main$socketUpdate);
			}
		});
	var _user$project$Main$DnD = function (a) {
	...
	var _user$project$Main$Join = {ctor: 'Join'};
	...
	var _user$project$Main$cardView = F5(
		function (connId, stage, dnd, columnId, _p24) {
			var _p25 = _p24;
			var _p28 = _p25._0;
			var _p27 = _p25._1;
			var content = _user$project$Main$contentsView(_p27.contents);
			var _p26 = stage;
			switch (_p26.ctor) {
				case 'Thinking':
					return A2(_user$project$Card$authored, connId, _p27) ? {
						ctor: '::',
						_0: A2(
							_user$project$Bulma$card,
							A2(
								_user$project$DragAndDrop$draggable,
								_user$project$Main$DnD,
								{ctor: '_Tuple2', _0: columnId, _1: _p28}),
							{
								ctor: '::',
								_0: A2(
									_user$project$Bulma$cardContent,
									{ctor: '[]'},
									{
										ctor: '::',
										_0: content,
				...
				case 'Presenting':
					return (!_p27.revealed) ? (A2(_user$project$Card$authored, connId, _p27) ? {
						ctor: '::',
						_0: A2(
							_user$project$Bulma$card,
							{
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'not-revealed', _1: !_p27.revealed},
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										A2(_user$project$Main$Reveal, columnId, _p28)),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_0: A2(
							...
							_elm_lang$core$List$concat(
								{
									...
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$DragAndDrop$dropzone,
											_user$project$Main$DnD,
											{
												ctor: '_Tuple2',
												_0: columnId,
								...
								}),
							{
								...
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Bulma$cardFooter,
										{ctor: '[]'},
										{
											ctor: '::',
											_0: A2(
												_user$project$Bulma$cardFooterItem,
												{ctor: '[]'},
												_elm_lang$core$Basics$toString(_p27.votes)),
											_1: {
												ctor: '::',
												_0: A2(
													_user$project$Bulma$cardFooterItem,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															A2(_user$project$Main$Vote, columnId, _p28)),
														_1: {ctor: '[]'}
													},
													'Vote'),
												_1: {ctor: '[]'}
	...
	var _user$project$Main$SetStage = function (a) {
		return {ctor: 'SetStage', _0: a};
	};
	var _user$project$Main$tabsView = function (stage) {
		var tab = function (s) {
			return A2(
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'is-active',
								_1: _elm_lang$core$Native_Utils.eq(stage, s)
							},
							_1: {ctor: '[]'}
						}),
					_1: {
		...
		return A2(
			_user$project$Bulma$tabs,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('is-toggle'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: tab(_user$project$Main$Thinking),
						_1: {
							ctor: '::',
							_0: tab(_user$project$Main$Presenting),
							_1: {
								ctor: '::',
								_0: tab(_user$project$Main$Voting),
								_1: {
									ctor: '::',
									_0: tab(_user$project$Main$Discussing),
									_1: {ctor: '[]'}
								}
							}
						}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('05:03 remaining'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
	...
	var _user$project$Main$ChangeInput = F2(
		function (a, b) {
			return {ctor: 'ChangeInput', _0: a, _1: b};
		});
	var _user$project$Main$addCardView = function (columnId) {
		return A2(
			_user$project$Bulma$card,
			{ctor: '[]'},
			{
								...
								_0: A2(
									_elm_lang$html$Html$textarea,
									{
										...
										_0: _elm_lang$html$Html_Events$onInput(
											_user$project$Main$ChangeInput(columnId)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Add a card...'),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
	...
	var _user$project$Main$columnView = F4(
		function (connId, stage, dnd, _p29) {
			var _p30 = _p29;
			var _p33 = _p30._0;
			var _p32 = _p30._1;
			var add = {
				ctor: '::',
				_0: _user$project$Main$addCardView(_p33),
				_1: {ctor: '[]'}
			};
			var list = _elm_lang$core$List$concat(
				A2(
					_elm_lang$core$List$map,
					A4(_user$project$Main$cardView, connId, stage, dnd, _p33),
					_elm_lang$core$Dict$toList(_p32.cards)));
			var title = {
				ctor: '::',
				_0: _user$project$Main$titleCardView(_p32.name),
				_1: {ctor: '[]'}
			};
			var _p31 = stage;
			if (_p31.ctor === 'Thinking') {
				return A2(
					_user$project$Bulma$column,
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									...
									_0: {
										...
										_1: _elm_lang$core$Native_Utils.eq(
											dnd.over,
											_elm_lang$core$Maybe$Just(
												{ctor: '_Tuple2', _0: _p33, _1: _elm_lang$core$Maybe$Nothing}))
									},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						title,
						A2(_elm_lang$core$Basics_ops['++'], list, add)));
			} else {
				return A2(
					_elm_lang$html$Html$div,
					{
					...
					A2(_elm_lang$core$Basics_ops['++'], title, list));
			}
		});
	var _user$project$Main$columnsView = F4(
		function (connId, stage, dnd, columns) {
			return A2(
				_user$project$Bulma$columns,
				{ctor: '[]'},
				A2(
					_elm_lang$core$List$map,
					A3(_user$project$Main$columnView, connId, stage, dnd),
					_elm_lang$core$Dict$toList(columns)));
		});
	var _user$project$Main$view = function (model) {
		var modal = _user$project$Bulma$modal(
			{
				ctor: '::',
				_0: A2(
					_user$project$Bulma$box,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/oauth/login'),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Sign-in with GitHub'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('A link to github?'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
		...
		var tabs = A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$tabsView(model.stage),
						_1: {
							ctor: '::',
							_0: A4(_user$project$Main$columnsView, model.user, model.stage, model.dnd, model.retro.columns),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
	...
	var _user$project$Main$Socket = function (a) {
		return {ctor: 'Socket', _0: a};
	};
	var _user$project$Main$SetId = function (a) {
	...
	var _user$project$Main$subscriptions = function (model) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: A2(_user$project$Sock$listen, 'ws://localhost:8080/ws', _user$project$Main$Socket),
				_1: {
					ctor: '::',
					_0: _user$project$Main$storageGot(_user$project$Main$SetId),
					_1: {ctor: '[]'}
				}
			});
	};
